...
namespace SimpleModelsAndRelations
{
  ...
  public class Startup
  {
    ...
    public void Configure(IApplicationBuilder app, IOptions<ApiOptions> apiOptionsAccessor, IHostingEnvironment env, ILoggerFactory loggerFactory, SomeContext dbContext, IAntiforgery antiforgery )
    {
